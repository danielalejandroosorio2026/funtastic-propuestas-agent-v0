...
> Estado: la arquitectura y el runner están implementados. Las tres entradas provienen de consultas comerciales reales reconstruidas y anonimizadas. Los servicios y políticas fueron contrastados con la propuesta comercial v3, y los precios de diciembre de 2026 con la lista específica aportada por el propietario.
...
- `read_business_file`: lee exclusivamente las seis fuentes autorizadas.
- `calculate_quote`: calcula paquete, excedentes y adicionales de forma determinística.

Las herramientas usan schemas cerrados. El modelo no calcula precios por su cuenta. Selecciona de forma determinística la tarifa de lunes a jueves o de viernes a domingo/feriado. Si falta la fecha o un importe, devuelve el concepto pendiente y un total nulo.
...
Los tests validan las tres salidas, los datos faltantes, las recomendaciones, las dos tarifas de diciembre, los excedentes sin mezclar cupos, la hora adicional, la detención cuando falta fecha, el límite de capacidad y el rechazo de adicionales inexistentes.
...
Las inclusiones, políticas y precios de diciembre de 2026 están verificados. Como las consultas reconstruidas no incluyen fecha, sus cotizaciones quedan pendientes hasta determinar el tipo de día.
